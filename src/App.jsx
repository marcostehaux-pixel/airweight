...
doc.text('AIRWEIGHT LOADSHEET', 20, 20)
...
doc.text(
  `Forward Cargo: ${forwardCargo} kg`,
  20,
  120
)

doc.text(
  `Aft Cargo: ${aftCargo} kg`,
  20,
  130
)
...
doc.text('Weight Summary', 20, 165)
...
doc.text(
  `ZFW: ${zfw.toFixed(0)} kg`,
  20,
  180
)

doc.text(
  `TOW: ${tow.toFixed(0)} kg`,
  20,
  190
)
